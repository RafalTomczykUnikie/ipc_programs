...
void IpcQueueTest::SetUp(void)
{
    ...
    m_file_sender = new QueueFileSender(m_comand_sender, "/test_queue");
    m_file_receiver = new QueueFileReceiver(m_comand_receiver, "/test_queue");    
}

void IpcQueueTest::TearDown(void)
{
    delete m_server;
    delete m_client;
    delete m_comand_receiver;
    delete m_comand_sender;
    delete dynamic_cast<QueueFileReceiver *>(m_file_receiver);
    delete dynamic_cast<QueueFileSender *>(m_file_sender);
}

TEST_F(IpcQueueTest, TestConstructor)
{
    auto *snd = dynamic_cast<QueueFileSender *>(m_file_sender);
    auto *rcv = dynamic_cast<QueueFileReceiver *>(m_file_receiver);
...
TEST_F(IpcQueueTest, TestFileSendingReceivingSmallFile)
{
...
TEST_F(IpcQueueTest, TestFileSendingReceivingLargeFile)
{
...
TEST_F(IpcQueueTest, TestWrongFileAgreement)
{
